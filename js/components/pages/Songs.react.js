...
export default class Songs extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <div className="fixed left-0 right-0 top-0 z1 px2 bg-purple" style={{marginTop: '35px'}}>
        ...
        <div className="p2 overflow-scroll" style={{marginBottom: '60px', marginTop: '155px'}}>
